...
public class FollowerConstants {
    ...
    private static double xMovement = 75;//80
    private static double yMovement = 50;//55
    ...
    public static double mass = 14.15;
    ...
    public static double forwardZeroPowerAcceleration = -32.9781;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration =-33.2; // -81.0376;
