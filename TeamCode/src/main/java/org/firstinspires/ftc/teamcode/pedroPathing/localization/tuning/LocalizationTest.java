...
public class LocalizationTest extends OpMode {
    ...
    public static double SampelData =0;
    ...
    public void loop() {
        ...
        telemetryA.addData("total heading", poseUpdater.getNavxHeading());

        telemetryA.addData("leftFront",leftFront.getCurrent(CurrentUnit.AMPS));
        telemetryA.addData("leftRear",leftRear.getCurrent(CurrentUnit.AMPS));
        telemetryA.addData("rightFront",rightFront.getCurrent(CurrentUnit.AMPS));
        telemetryA.addData("rightRear",rightRear.getCurrent(CurrentUnit.AMPS));
